...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        hospitalRepository.save(new Hospital(2L, "Hospital Nossa Senhora", "Fernanda Lima", LocalDate.of(2023, 6, 30), new Endereco(45678901, "Travessa do Bem-Estar", 012, "Bairro Sossego", "Setor Pediátrico"), new CNPJ("4567890123456"), false, null));
